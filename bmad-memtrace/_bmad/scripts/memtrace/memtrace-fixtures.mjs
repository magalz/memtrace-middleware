export const fixtures = {
  ...
  find_dead_code: (target) => ({
    symbols: [
      { name: 'deprecatedHelper', kind: 'Function', file: 'src/utils/old-helpers.ts', line: 12, complexity_score: 2, risk_level: 'Low' },
      { name: 'unusedParser', kind: 'Function', file: 'src/parser/legacy.ts', line: 45, complexity_score: 8, risk_level: 'Medium' },
      { name: 'deadExporter', kind: 'Function', file: 'src/export/stale.ts', line: 78, complexity_score: 3, risk_level: 'Low' }
    ]
  }),
